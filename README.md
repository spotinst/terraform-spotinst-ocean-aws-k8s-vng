...
| <a name="reserved_enis"></a> [reserved\_enis](#input\_respect\_pdb)                                                             | Default: 0. Specifies the count of ENIs to reserve per instance type for scaling purposes.                                                                                                                                                                                                                                                | `number`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `0`       | no |
## Outputs
